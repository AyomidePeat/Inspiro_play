...
class SongApi {
  ...
  var uri = Uri.https('spotify23.p.rapidapi.com', '/artists/', {
    'ids': '3SgHzT552wy2W8pNLaLk24,22JNV0JWTJkY1qzKJhxdRe,7eEP4TA1RioDH3OBKPcQEC,509E47UmbRPKWPXOMaieh2,06HL4z0CvFAxyc27GXpf02,1ukmGETCwXTbgrTrkRDnmn',
  });
  ...
  if (response.statusCode != 200) {
    throw Exception('Failed to retrieve playlist tracks: ${response.statusCode}');
  }
